 ...
 * 
 * @details Experimental details from LaValle (1998):
 *  - This finding applies to 2D, convex spaces
 */
 ...
 *  - The figure shows rectangular, triangular, and hexagonal static obstacles
 ...
 *  - Per the caption on Figure 1, this RRT has a 5D state space
